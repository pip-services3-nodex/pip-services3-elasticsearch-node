 ...
 */
class ElasticSearchLogger extends pip_services3_components_nodex_1.CachedLogger {
    /**
    ...
    getLogItem() {
        return this._include_type_name ?
            { _index: this._currentIndex, _type: "log_message", _id: pip_services3_commons_nodex_1.IdGenerator.nextLong() } : // ElasticSearch 6.x
            { _index: this._currentIndex, _id: pip_services3_commons_nodex_1.IdGenerator.nextLong() }; // ElasticSearch 7.x
    }
}
